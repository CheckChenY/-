                    ...
                    <div>
                        ...
                        <Col span={5} >
                            <Button className='my-information-right-button' onClick={getLoadingBool}>
                                <img alt='金融搜索' src={imgoneURL3} style={{width:'9px', height:'9px',marginRight:'4px'}}/>
                                编辑资料
                            </Button>
                        </Col>
                        </Row>
                ...
                <Row>
                    ...
                    <div style={{marginTop: '40px', verticalAlign:'bottom',display:'inline-block'}}>
                        ...
                        <Button className='modify-information-button'>
                            <img alt='aaa' src={imgoneURL8} style={{width:'14px', height:'14px',marginRight:'4px'}}/>
                    ...
                    <div>
                        ...
                        <Col span={10}>
                            ...
                            <FormItem>
                                ...
                                htmlType="submit" 
                                className='modify-information-form-button'>保存</Button>
                            </FormItem>
                            </Col>
                            <Col span={1}></Col>
                            <Col span={10}>
